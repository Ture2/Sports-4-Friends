	...
	<div id="contenido">
		<div id="datos">
			<fieldset id="perfil">
				...
				<p id="perfil">Ciudad o provincia: <select name="ciudad" size="1">
            ...
            <option value='Zaragoza'>Zaragoza</option>
				...
				<p id="perfil">Fecha quedada:  <input type="date" name="fecha_quedada" value="2019-08-08"min="2018-03-25"
                                  max="2020-05-25" step="1"></p>
				<p id="perfil">Hora quedada: <input type="time" name="hora_quedada" value="11:45:00" max="22:30:00" min="10:00:00" step="1"></p>
