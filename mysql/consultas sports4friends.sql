...
INSERT INTO USUARIOS (NICKNAME, NOMBRE,  APELLIDOS, TELEFONO, CORREO, PASSWORD) VALUES ("sofi7", "Sofia", "Garcia Lopez", 677777777, "susanalopez@gmail.com", "ss77");
...
INSERT INTO USUARIOS (NICKNAME, NOMBRE,  APELLIDOS, TELEFONO, CORREO, PASSWORD) VALUES ("sofi8", "Sofia", "Garcia Lopez", NULL, "susanaalegria@gmail.com", "ss77");
...
INSERT INTO USUARIOS (NICKNAME, NOMBRE,  APELLIDOS, TELEFONO, CORREO, PASSWORD) VALUES ("juli9", "Julia", "Hernandez Blanco", NULL, "susanaalegria@gmail.com", "yy44");
...
INSERT INTO USUARIOS (NICKNAME, NOMBRE,  APELLIDOS, TELEFONO, CORREO, PASSWORD) VALUES ("robert10", "Roberto", "Ruiz", NULL, "robertoruiz@gmail.com", "2223B");

-- INSERTAR UN USUARIO SIN CONTRASEÑA, DEBERIA NO DEJAR INTRODUCIRLO. NO OK, AL FINAL NO DEJA INTRODUCIRLO
INSERT INTO USUARIOS (NICKNAME, NOMBRE,  APELLIDOS, TELEFONO, CORREO, PASSWORD) VALUES ("marta11", "Marta", "Rodriguez", 777777771, "marta4@gmail.com", NULL);

-- INSERTAR UNA PERSONA SIN QUE PONGA NICKNAME. NO OK
INSERT INTO USUARIOS (NICKNAME, NOMBRE,  APELLIDOS, TELEFONO, CORREO, PASSWORD) VALUES (NULL, "Ruben", "Rodriguez", 619132345, "rueben4@gmail.com", "DFEFDSD");

-- INSERTAR UN USUARIO SIN QUE PONGA UN NOMBRE O SIN NIGUN APELLIDO. NO OK
INSERT INTO USUARIOS (NICKNAME, NOMBRE,  APELLIDOS, TELEFONO, CORREO, PASSWORD) VALUES ("marcos345", "Marcos", NULL, 619132367, "marcosper@gmail.com", "ASDSDF");
...
UPDATE USUARIOS
SET NICKNAME = 'sofi7', TELEFONO = 677777787, CORREO = 'susanafeliz@gmail.com', PASSWORD = 'pp775'
...
-- YA EXISTENTE, NO OK.
UPDATE USUARIOS
SET NICKNAME = 'alv1', TELEFONO = 677777777, CORREO = 'susanafelizz@gmail.com', PASSWORD = 'pp776'
WHERE NICKNAME = 'sofi7';

--CAMBIAR EL CAMPO TELEFONO A NULL. ESO SI SE ACEPTA. CON EL RESTO DE CAMPOS DARIA ERROR. EN ESTE CASO OK.
UPDATE USUARIOS
SET NICKNAME = 'sofi7best', TELEFONO = NULL, CORREO = 'susanafelizz@gmail.com', PASSWORD = 'pp776'
WHERE NICKNAME = 'sofi7';
...
UPDATE USUARIOS
SET NICKNAME = 'sofi7', TELEFONO = NULL, CORREO = 'susanafelizzz@gmail.com', PASSWORD = NULL
WHERE NICKNAME = 'sofi7best';
...
-- PARA SABER EL NUMERO DE USUARIOS QUE TENEMOS EN LA APLICACION WEB
...
-- CONSULTA PARA SABER EL NUMERO DE JUGADORES QUE JUEGAN AL FÚTBOL EN EL EQUIPO REAL MADRID

SELECT COUNT(U.ID_USUARIO) AS TOTAL_JUGADORES
FROM usuarios u
JOIN jugadores j ON u.ID_USUARIO = j.USUARIO
JOIN equipos e ON j.EQUIPO = e.ID_EQUIPO
JOIN deportes d ON e.DEPORTE = d.ID_DEPORTE AND d.NOMBRE_DEPORTE = 'Futbol' AND e.NOMBRE_EQUIPO = 'REAL MADRID';

-- CONSULTA PARA SABER LOS USUARIOS QUE JUEGAN AL FÚTBOL EN EL EQUIPO REAL MADRID

SELECT u.NOMBRE, u.APELLIDOS AS TOTAL_JUGADORES
FROM usuarios u
JOIN jugadores j ON u.ID_USUARIO = j.USUARIO
JOIN equipos e ON j.EQUIPO = e.ID_EQUIPO
JOIN deportes d ON e.DEPORTE = d.ID_DEPORTE AND d.NOMBRE_DEPORTE = 'Futbol' AND e.NOMBRE_EQUIPO = 'REAL MADRID';
...
INSERT INTO `sports4friends`.`deportes` (`NOMBRE_DEPORTE`, `NUMERO_MAXIMO_JUGADORES`, `DURACION_MIN` ) VALUES ('HOCKEY', '20', '60');
...
INSERT INTO `sports4friends`.`equipos` (`DEPORTE`, `NOMBRE_EQUIPO`) VALUES ('880001', 'VALENCIA');
...
INSERT INTO `sports4friends`.`equipos` (`DEPORTE`, `NOMBRE_EQUIPO`) VALUES ('880004', 'VALENCIA');
...
INSERT INTO `sports4friends`.`jugadores` (`EQUIPO`, `USUARIO`, `Admin_team`) VALUES ('550001', '7', '0');
INSERT INTO `sports4friends`.`jugadores` (`EQUIPO`, `USUARIO`, `Admin_team`) VALUES ('550001', '8', '0');
INSERT INTO `sports4friends`.`jugadores` (`EQUIPO`, `USUARIO`, `Admin_team`) VALUES ('550001', '9', '0');
INSERT INTO `sports4friends`.`jugadores` (`EQUIPO`, `USUARIO`, `Admin_team`) VALUES ('550002', '10', '0');
INSERT INTO `sports4friends`.`jugadores` (`EQUIPO`, `USUARIO`, `Admin_team`) VALUES ('550002', '11', '0');
INSERT INTO `sports4friends`.`jugadores` (`EQUIPO`, `USUARIO`, `Admin_team`) VALUES ('550002', '12', '0');
INSERT INTO `sports4friends`.`jugadores` (`EQUIPO`, `USUARIO`, `Admin_team`) VALUES ('550002', '13', '0');
INSERT INTO `sports4friends`.`jugadores` (`EQUIPO`, `USUARIO`, `Admin_team`) VALUES ('550003', '14', '0');
INSERT INTO `sports4friends`.`jugadores` (`EQUIPO`, `USUARIO`, `Admin_team`) VALUES ('550003', '15', '0');
INSERT INTO `sports4friends`.`jugadores` (`EQUIPO`, `USUARIO`, `Admin_team`) VALUES ('550003', '16', '0');
INSERT INTO `sports4friends`.`jugadores` (`EQUIPO`, `USUARIO`, `Admin_team`) VALUES ('550003', '17', '0');
...
UPDATE `sports4friends`.`jugadores` SET `Admin_team` = '1' WHERE (`ID_JUGADOR` = '330001');
UPDATE `sports4friends`.`jugadores` SET `Admin_team` = '1' WHERE (`ID_JUGADOR` = '330003');
UPDATE `sports4friends`.`jugadores` SET `Admin_team` = '1' WHERE (`ID_JUGADOR` = '330005');

--quedarnos con el id y actualizar

UPDATE sports4friends.jugadores SET admin_team = 1
